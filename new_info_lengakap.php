...
<body>
                        ...
                        <div class="d-flex info" style="flex-wrap: wrap;">
                            ...
                            ?>
                                    <div class="infoItem" style="width: 250px; box-sizing: border-box; margin-bottom: 40px;">
                                        <div class="infoIsi">
                                            <div id="gambar_<?php echo $id; ?>"></div>
                                            <img src="<?php echo $gambar; ?>" alt="<?php echo $judul; ?>" style="width: 100%;">
                                        </div>
                                        <p id="judul_<?php echo $id; ?>" style="text-align: center;"><?php echo $judul; ?></p>
                                        <button class="editButton" data-id="<?php echo $id; ?>" onclick="editInfo(<?php echo $id; ?>)">Edit</button>
                                    </div>
                                <?php
                                    $counter++;
                                    if ($counter % 3 == 0) {
    ...
    <script>
        ...
        function editInfo(id) {
            var gambarElement = document.getElementById("gambar_" + id);
            var judulElement = document.getElementById("judul_" + id);
        ...
        function saveInfo() {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    document.getElementById("gambar_" + id).src = newGambar;
                    document.getElementById("judul_" + id).innerText = newJudul;
